    ...
    companion object {
        ...
        fun renderView(json : String, context : Context) : View? {
            return when (RenderUtil.getType(json)) {
                ...
                "View" -> RenderUtil.renderView(context, com.patzhum.matcha.render.MatchaView::class.java, json)
                else -> null
            }
        }

        fun <ViewType: View, StateType: MatchaBaseView.State, MatchaViewType: MatchaBaseView<ViewType, StateType>>
            renderView(
                context: Context,
        ...
        fun getType(jsonString : String) : String? {
            ...
            try {
                val viewState = gson.fromJson<MatchaBaseView.State>(jsonString, MatchaBaseView.State::class.java)
